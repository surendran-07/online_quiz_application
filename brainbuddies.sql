...
-- Database: `chatappv1`
--
CREATE DATABASE IF NOT EXISTS `chatappv1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `chatappv1`;
...
(10, 'alpha', 'a', '', '', '', '', 'california', '', '', '0000-00-00', 'Male', '9876543210', '', 0, 'alpha', '165d3ce1fed14d9ef85dfb1c2e7cae3921796814', '', 1, '2024-10-02'),
(11, 'beta', 'b', '', '', '', '', 'california', '', '', '0000-00-00', 'Male', '9876543208', '', 0, 'alpha', '165d3ce1fed14d9ef85dfb1c2e7cae3921796814', '', 1, '2024-10-02');
...
(1, 'Casual Shirt', 'Elegant Casual dress perfect for any event', 100.00, 'prod1.jpg'),
(2, 'Formal Shirt', 'Elegant Formal dress perfect for any event', 150.00, 'prod2.jpg'),
(3, 'Grey pant', 'Elegant grey dress perfect for any event.', 120.00, 'prod3.jpg'),
(4, 'Black pant', 'Description of Product 4', 200.00, 'prod4.jpg'),
(5, 'blue shoes', 'Comfortable and stylish blue sneakers.', 80.00, 'prod5.jpg'),
(6, 'Red Sneakers', 'Comfortable and stylish red sneakers.', 50.99, 'prod6.jpg'),
(7, 'Blue Denim Jacket', 'Trendy blue denim jacket for all occasions.', 75.49, 'prod7.jpg'),
(8, 'Black Leather Wallet', 'Premium black leather wallet.', 25.00, 'prod8.jpg'),
(9, 'Wireless Headphones', 'Bluetooth-enabled wireless headphones.', 89.99, 'prod9.jpg'),
(10, 'Smart Watch', 'Modern smartwatch with fitness tracking.', 149.99, 'prod10.jpg'),
(11, 'Red Dress', 'Elegant red dress perfect for any event.', 120.00, 'prod11.jpg'),
(12, 'Black Sunglasses', 'Stylish black sunglasses for sunny days.', 30.00, 'prod12.jpg'),
(13, 'Blue Running Shoes', 'High-performance blue running shoes.', 60.00, 'prod13.jpg'),
(14, 'Leather Jacket', 'Premium black leather jacket.', 200.00, 'prod14.jpg'),
(15, 'Gaming Mouse', 'RGB-backlit gaming mouse with high precision.', 45.00, 'prod15.jpg');
...
(1, 'john_doe', 'john@example.com', '482c811da5d5b4bc6d497ffa98491e38'),
(2, 'jane_doe', 'jane@example.com', '482c811da5d5b4bc6d497ffa98491e38'),
(3, 'mike_smith', 'mike@example.com', '482c811da5d5b4bc6d497ffa98491e38'),
(4, 'beta', 'beta123@gmail.com', '6bd402bb2b64948b70e6433deddf0688'),
(5, 'alpha', 'beta123@gmail.com', '6bd402bb2b64948b70e6433deddf0688'),
(6, 'charlie', 'charlie123@gmail.com', '202cb962ac59075b964b07152d234b70'),
(7, 'delta', 'delta123@gmail.com', '202cb962ac59075b964b07152d234b70'),
(8, 'dell', 'dell123@gmail.com', '202cb962ac59075b964b07152d234b70');
...
-- Database: `employe`
--
CREATE DATABASE IF NOT EXISTS `employe` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `employe`;
--
...
INSERT INTO `employees` (`id`, `name`, `position`, `age`, `department`) VALUES
(2, 'alpha', 'assistant', 28, 'HR'),
(3, 'beta', 'assistant', 29, 'HR');
...
-- Database: `mysqli`
--
CREATE DATABASE IF NOT EXISTS `mysqli` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `mysqli`;
...
('root', '2024-08-03 12:04:41', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"en_GB\"}');
...
-- Database: `prosan`
--
CREATE DATABASE IF NOT EXISTS `prosan` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `prosan`;
...
('user', 'password'),
('robert', 'robert123'),
('Neeraj Nirmal', 'nirmal123'),
('kathick raja', 'kathick123'),
('robert', 'robert123'),
('alpha', 'alpha123'),
('beta', 'beta123'),
('user', 'user123'),
...
-- Database: `prozan`
--
CREATE DATABASE IF NOT EXISTS `prozan` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `prozan`;
